                    ...
                    <div>
                        ...
                        <div class="mt-2 flex flex-col items-center">
                            ...
                            <div id="previewContainer" class="w-full aspect-video rounded-2xl overflow-hidden border-2 border-dashed border-gray-200 shadow-inner bg-gray-50">
                                <img id="imagePreview" src="https://placehold.co/600x400?text=Paste+URL+Above" alt="Preview Flayer" class="w-full h-full object-cover" onerror="this.src='https://placehold.co/600x400?text=Invalid+URL'">
                            </div>
