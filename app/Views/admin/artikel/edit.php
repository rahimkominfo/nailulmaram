                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-2 flex flex-col items-center">
                                <div id="previewContainer" class="mb-4 w-full h-40 rounded-xl overflow-hidden border-2 border-dashed border-gray-200 <?= $artikel['gambar_utama'] ? '' : 'hidden' ?>">
                                    <img id="imagePreview" src="<?= $artikel['gambar_utama'] ? base_url('uploads/artikel/'.$artikel['gambar_utama']) : '' ?>" alt="Preview Gambar Utama Artikel" class="w-full h-full object-cover">
                                </div>
